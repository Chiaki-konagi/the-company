...
class User extends Database{
    ...
    public function login($request){
        ...
        if($result->num_rows == 1){
            // Change the format to an associatetive array
    ...
    public function update($request, $files){
        ...
        if($this->conn->query($sql)){
            ...
            // if there is an uploaded the photo,save it to the database and save the file to image forlder.//
            if($photo){
                ...
                if($this->conn->query($sql)){
                    // save the uploaded photo to image folder
